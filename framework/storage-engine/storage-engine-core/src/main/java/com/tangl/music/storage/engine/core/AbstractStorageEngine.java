package com.tangl.music.storage.engine.core;
...
public abstract class AbstractStorageEngine implements StorageEngine {
    ...
    protected Cache getCache() {
        if (Objects.isNull(cacheManager)) {
            throw new CoCoMusicFrameworkException("the cache manager is empty!");
        }
        return cacheManager.getCache(CacheConstants.COCO_MUSIC_CACHE_NAME);
    }
}
