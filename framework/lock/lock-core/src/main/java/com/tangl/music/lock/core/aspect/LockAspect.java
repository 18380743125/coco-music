...
public class LockAspect implements ApplicationContextAware {
    ...
    @Pointcut(value = "@annotation(com.tangl.music.lock.core.annotation.Lock)")
    ...
    public Object aroundLock(ProceedingJoinPoint proceedingJoinPoint) {
        ...
        if (Objects.isNull(lock)) {
            ...
            throw new CoCoMusicFrameworkException("aroundLock get lock fail");
        }
        ...
        try {
            ...
            throw new CoCoMusicFrameworkException("aroundLock tryLock fail.");
        } finally {
            if (lockResult) {
                lock.unlock();
            }
