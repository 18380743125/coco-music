 ...
 */
@Getter
public class CoCoMusicBusinessException extends RuntimeException {
    ...
    public CoCoMusicBusinessException(ResponseCode responseCode) {
        this.code = responseCode.getCode();
        this.message = responseCode.getDesc();
    }

    public CoCoMusicBusinessException(Integer code, String message) {
        this.code = code;
        this.message = message;
    }

    public CoCoMusicBusinessException(String message) {
        this.code = ResponseCode.ERROR_PARAM.getCode();
        this.message = message;
    }

    public CoCoMusicBusinessException() {
        this.code = ResponseCode.ERROR_PARAM.getCode();
